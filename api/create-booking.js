  ...
  try {
    ...
    try {
      ...
      await resend.emails.send({
        ...
        subject: `🎯 New Booking: ${bookingData.customer_name} - ${bookingData.organization_name}`,
        html: `
          <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
            ...
            <div style="background: #f9fafb; padding: 20px; border-radius: 10px; border-left: 4px solid #6366f1;">
              ...
              <div style="margin-top: 15px;">
                <a href="https://wa.me/${bookingData.phone.replace(/[^0-9]/g, '')}?text=Hi%20${encodeURIComponent(bookingData.customer_name)}!%20This%20is%20Carls%20Newton.%20Thank%20you%20for%20booking%20${encodeURIComponent(packageNames[bookingData.package_type])}%20for%20${encodeURIComponent(formattedDate)}.%20Let%27s%20confirm%20the%20details!"
            ...
            <div style="background: #eff6ff; padding: 20px; border-radius: 10px; margin-top: 20px; border-left: 4px solid #3b82f6;">
              ...
              ${bookingData.address_details ? `<p><strong>Location Details:</strong> ${bookingData.address_details}</p>` : ''}
            ...
            <p style="margin-top: 20px; color: #6b7280; font-size: 14px;">
              🎯 Time to bring the science magic! Click the WhatsApp button above for instant contact.
            </p>
          </div>
        `,
      });
        ...
        html: `
          <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
            ...
            <div style="text-align: center; margin: 30px 0;">
              <a href="https://wa.me/971543771243?text=Hi%20Carls%20Newton!%20I%20just%20booked%20${encodeURIComponent(packageNames[bookingData.package_type])}%20for%20${formattedDate}%20(Booking%20ID:%20${booking.id}).%20I%20have%20a%20question!"
